...
class UserBankAccountAdmin(admin.ModelAdmin):
    list_display = ['get_account_number', 'cpf', 'user_email', 'account_type', 'balance', 'gender', 'initial_deposit_date']
    list_filter = ['account_type', 'gender', 'initial_deposit_date']
    search_fields = ['cpf', 'user__email', 'user__first_name', 'user__last_name']
    readonly_fields = ['get_account_number', 'initial_deposit_date', 'interest_start_date']
