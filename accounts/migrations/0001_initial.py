...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('cpf', models.CharField(help_text='CPF no formato XXX.XXX.XXX-XX', max_length=14, unique=True, validators=[accounts.validators.validate_cpf])),
                ('agencia', models.CharField(help_text='Código da agência (4 dígitos)', max_length=4)),
                ('agencia_digito', models.CharField(help_text='Dígito verificador da agência', max_length=1)),
                ('conta', models.CharField(help_text='Número da conta', max_length=8)),
                ('conta_digito', models.CharField(help_text='Dígito verificador da conta', max_length=1)),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['cpf'], name='accounts_us_cpf_c382b1_idx'),
        ),
        migrations.AddIndex(
            model_name='userbankaccount',
            index=models.Index(fields=['agencia', 'conta'], name='accounts_us_agencia_c1877d_idx'),
        ),
