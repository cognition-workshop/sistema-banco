...
savings_type, _ = BankAccountType.objects.get_or_create(
    ...
    defaults={"maximum_withdrawal_amount": 5000.00, "annual_interest_rate": 5.00, "interest_calculation_per_year": 12},
)

current_type, _ = BankAccountType.objects.get_or_create(
    name="Current Account",
    defaults={"maximum_withdrawal_amount": 10000.00, "annual_interest_rate": 2.50, "interest_calculation_per_year": 6},
)
...
address, _ = UserAddress.objects.get_or_create(
    user=demo_user, defaults={"street_address": "123 Main Street", "city": "New York", "postal_code": 10001, "country": "USA"}
)
...
for trans_type, amount, timestamp in transactions_data:
    ...
    Transaction.objects.create(
        account=account, amount=amount, balance_after_transaction=balance, transaction_type=trans_type, timestamp=timestamp
    )
