...
SECRET_KEY = config(
    "SECRET_KEY", default="po0172$69b@78ps4v^uhfxu6q--8ko7kpp7rbz420s_3w#sir%"
)
...
MIDDLEWARE = [
    ...
    "banking_system.middleware.ErrorHandlingMiddleware",
    "banking_system.middleware.SecurityHeadersMiddleware",
]
