...
def process_interest_calculation():
    ...
    This function:
    - Queries accounts with positive balance and valid interest dates
    - Checks if current month is an interest calculation month
    - Calculates interest using the account type's formula
    - Updates account balances
    - Creates interest transaction records
    
    Returns:
        tuple: (created_transactions, updated_accounts)
    """
